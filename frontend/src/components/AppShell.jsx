...
const AppShell = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Failed to set sidebar collapsed state:", e);
    }
  }, [collapsed]);
      ...
      <div className={appShellStyles.layout}>
        ...
        <aside className={appShellStyles.sidebar}>
          ...
          <div className={`${appShellStyles.logoContainer} ${collapsed ? appShellStyles.logoContainerCollapsed : ''}`}>
            <Link to="/app" className={appShellStyles.logoLink}>
              ...
              {!collapsed && (
                <div className={appShellStyles.logoTextContainer}>
                  ...
                  <div className={appShellStyles.logoDivider} />
                </div>
              )}
            </Link>
          </div>
          ...
          <nav className={appShellStyles.nav}>
            ...
            `}>
              {({ isActive }) => (
                <>
                  <div className={`${appShellStyles.sidebarIcon} ${isActive ? appShellStyles.sidebarIconActive : appShellStyles.sidebarIconInactive}`}>
                    <DashboardIcon />
                  </div>
                  {!collapsed && <span className={appShellStyles.sidebarText}>Dashboard</span>}
                  {!collapsed && isActive && <div className={appShellStyles.sidebarActiveIndicator} />}
                </>
              )}
            </NavLink>

            <NavLink to="/app/invoices" className={({ isActive }) => `
              ${appShellStyles.sidebarLink}
              ${collapsed ? appShellStyles.sidebarLinkCollapsed : ""}
              ${isActive ? appShellStyles.sidebarLinkActive : appShellStyles.sidebarLinkInactive}
            `}>
              {({ isActive }) => (
                <>
                  ...
                  {!collapsed && <span className={appShellStyles.sidebarText}>Invoices</span>}
                  {!collapsed && isActive && <div className={appShellStyles.sidebarActiveIndicator} />}
                </>
              )}
            </NavLink>

            <NavLink to="/app/create-invoice" className={({ isActive }) => `
              ${appShellStyles.sidebarLink}
              ${collapsed ? appShellStyles.sidebarLinkCollapsed : ""}
              ${isActive ? appShellStyles.sidebarLinkActive : appShellStyles.sidebarLinkInactive}
            `}>
              {({ isActive }) => (
                <>
                  ...
                  {!collapsed && <span className={appShellStyles.sidebarText}>Create Invoice</span>}
                  {!collapsed && isActive && <div className={appShellStyles.sidebarActiveIndicator} />}
                </>
              )}
            </NavLink>

            <NavLink to="/app/business" className={({ isActive }) => `
              ${appShellStyles.sidebarLink}
              ${collapsed ? appShellStyles.sidebarLinkCollapsed : ""}
              ${isActive ? appShellStyles.sidebarLinkActive : appShellStyles.sidebarLinkInactive}
            `}>
              {({ isActive }) => (
                <>
                  ...
                  {!collapsed && <span className={appShellStyles.sidebarText}>Business Profile</span>}
                  {!collapsed && isActive && <div className={appShellStyles.sidebarActiveIndicator} />}
                </>
              )}
            </NavLink>
          ...
          {/* User Section */}
          <div className={collapsed ? appShellStyles.userDividerCollapsed : appShellStyles.userDividerExpanded}>
            {!collapsed ? (
          ...
          <div className={appShellStyles.collapseSection}>
            <button onClick={toggleSidebar} className={`${appShellStyles.collapseButtonInner} ${collapsed ? appShellStyles.collapseButtonCollapsed : ''}`}>
              <svg className={`w-4 h-4 transition-transform duration-300 ${collapsed ? "rotate-180" : ""}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <>
            ...
            <div className={appShellStyles.mobileSidebar}>
              <div className={appShellStyles.mobileHeader}>
                <Link to="/app" className={appShellStyles.mobileLogoLink} onClick={() => setMobileOpen(false)}>
              ...
              <nav className={appShellStyles.mobileNav}>
                <NavLink onClick={() => setMobileOpen(false)} to="/app/dashboard" className={({ isActive }) =>
                  `${appShellStyles.mobileNavLink} ${isActive ? appShellStyles.mobileNavLinkActive : appShellStyles.mobileNavLinkInactive}`
                }>
                  <DashboardIcon /> Dashboard
                </NavLink>
                <NavLink onClick={() => setMobileOpen(false)} to="/app/invoices" className={({ isActive }) =>
                  `${appShellStyles.mobileNavLink} ${isActive ? appShellStyles.mobileNavLinkActive : appShellStyles.mobileNavLinkInactive}`
                }>
                  <InvoiceIcon /> Invoices
                </NavLink>
                <NavLink onClick={() => setMobileOpen(false)} to="/app/create-invoice" className={({ isActive }) =>
                  `${appShellStyles.mobileNavLink} ${isActive ? appShellStyles.mobileNavLinkActive : appShellStyles.mobileNavLinkInactive}`
                }>
                  <CreateIcon /> Create Invoice
                </NavLink>
                <NavLink onClick={() => setMobileOpen(false)} to="/app/business" className={({ isActive }) =>
                  `${appShellStyles.mobileNavLink} ${isActive ? appShellStyles.mobileNavLinkActive : appShellStyles.mobileNavLinkInactive}`
                }>
              ...
              <div className={appShellStyles.mobileFooter}>
        ...
        <div className="flex-1 min-w-0">
          <header>
            <div className={`${appShellStyles.header} ${scrolled ? appShellStyles.headerScroll : appShellStyles.headerNotScroll}`}>
