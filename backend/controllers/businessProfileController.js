...
export async function createBusinessProfile(req, res) {
  try {
    ...
    // Build update object with ALL fields, including new ones
    const updateData = {
    ...
    // Upsert: find by owner and update, or create if not exists
    ...
    console.error("createBusinessProfile (upsert) error:", error);
...
// UPDATE BUSINESS PROFILE BY ID (optional, also include new fields)
